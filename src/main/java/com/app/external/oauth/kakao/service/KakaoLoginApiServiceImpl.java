...
public class KakaoLoginApiServiceImpl implements SocialLoginApiService {
  ...
  public OAuthAttributes getUserInfo(final String accessToken) {
    final KakaoUserInfoResponseDto kakaoUserInfoResponseDto = kakaoUserInfoClient.getKakaoUserInfo(CONTENT_TYPE,
        GrantType.BEARER.getType() + " " + accessToken);
    final KakaoAccount kakaoAccount = kakaoUserInfoResponseDto.getKakaoAccount();
    ...
    return OAuthAttributes.builder()
                          ...
                          .profile(kakaoAccount.getProfile().getThumbnamilImageUrl())
